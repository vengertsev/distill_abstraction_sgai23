#  Train 
export EXPERIMENT_ID="1022a"
export BERT_BASE_DIR="./_models/bert-base-uncased-rte"
...
#python ./TinyBERT/task_distill.py --pred_distill --teacher_model $BERT_BASE_DIR --student_model $MODEL_STG1_DIR --data_dir $TASK_DIR --task_name $TASK_NAME --output_dir $MODEL_STG2_DIR --do_lower_case --learning_rate 3e-5  --num_train_epochs  3 --eval_step 500 --max_seq_length 128 --train_batch_size 16 --aug_train >$LOG


export MODEL_STG2_DIR="./models_train/${MODEL_NAME}_1021_stg2_${TASK_NAME}"
#  Eval 
## on train
...
python ./TinyBERT/task_distill.py --do_eval   --student_model $MODEL_STG2_DIR   --data_dir $EVAL_ON_TRAIN_DIR  --task_name $TASK_NAME --output_dir $EVAL_ON_TRAIN_OUTPUT_DIR  --do_lower_case  --eval_batch_size 16 --max_seq_length 128  > $LOG
...
python ./TinyBERT/task_distill.py --do_eval    --student_model $MODEL_STG2_DIR   --data_dir $EVAL_ON_EVAL_DIR  --task_name $TASK_NAME --output_dir $EVAL_ON_EVAL_OUTPUT_DIR  --do_lower_case  --eval_batch_size 16 --max_seq_length 128  > $LOG
