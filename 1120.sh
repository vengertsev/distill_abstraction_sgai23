#  Train 
export EXPERIMENT_ID="1120"
export BERT_BASE_DIR="./_models/bert-base-uncased-WNLI"
...
# python ./TinyBERT/task_distill.py --teacher_model $BERT_BASE_DIR --student_model $GENERAL_TINYBERT_DIR --data_dir $TASK_DIR  --task_name $TASK_NAME --output_dir $MODEL_STG1_DIR --max_seq_length 128 --train_batch_size 32 --num_train_epochs 3 --do_lower_case >$LOG
#  --aug_train 
...
# python ./TinyBERT/task_distill.py --pred_distill --teacher_model $BERT_BASE_DIR --student_model $MODEL_STG1_DIR --data_dir $TASK_DIR --task_name $TASK_NAME --output_dir $MODEL_STG2_DIR --do_lower_case --learning_rate 3e-5  --num_train_epochs  3 --eval_step 5  --max_seq_length 128 --train_batch_size 32 >$LOG
# --aug_train 
# --eval_step 2000


# EVALUATION ON STG1 MODEL since STG2 is USELESS !!!!!!!
...
export EVAL_ON_TRAIN_OUTPUT_DIR="./eval_results/${EXPERIMENT_ID}_on_train"
export LOG="./logs/eval_${EXPERIMENT_ID}_on_train_$(date +%s).log"
python ./TinyBERT/task_distill.py --do_eval   --student_model $MODEL_STG1_DIR   --data_dir $EVAL_ON_TRAIN_DIR  --task_name $TASK_NAME --output_dir $EVAL_ON_TRAIN_OUTPUT_DIR  --do_lower_case  --eval_batch_size 32 --max_seq_length 128  > $LOG

## on eval
export EVAL_ON_EVAL_DIR="./_data/glue_data/${TASK_NAME}"
export EVAL_ON_EVAL_OUTPUT_DIR="./eval_results/${EXPERIMENT_ID}_on_eval"
export LOG="./logs/eval_${EXPERIMENT_ID}_on_eval_$(date +%s).log"
python ./TinyBERT/task_distill.py --do_eval    --student_model $MODEL_STG1_DIR   --data_dir $EVAL_ON_EVAL_DIR  --task_name $TASK_NAME --output_dir $EVAL_ON_EVAL_OUTPUT_DIR  --do_lower_case  --eval_batch_size 32 --max_seq_length 128  > $LOG
