#  Train 
export EXPERIMENT_ID="1168"
export BERT_BASE_DIR="./_models/bert-base-uncased-QQP"
...
python ./TinyBERT/task_distill.py --pred_distill --teacher_model $BERT_BASE_DIR --student_model $MODEL_STG1_DIR --data_dir $TASK_DIR --task_name $TASK_NAME --output_dir $MODEL_STG2_DIR --do_lower_case --learning_rate 3e-5  --num_train_epochs  3 --eval_step 500 --max_seq_length 128 --train_batch_size 32 >$LOG
