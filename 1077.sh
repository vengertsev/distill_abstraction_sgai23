...
python ./TinyBERT/task_distill.py --teacher_model $BERT_BASE_DIR --student_model $GENERAL_TINYBERT_DIR --data_dir $TASK_DIR  --task_name $TASK_NAME --output_dir $MODEL_STG1_DIR --max_seq_length 128 --learning_rate 5e-6  --train_batch_size 32 --num_train_epochs 3 --do_lower_case --aug_train >$LOG
